...
@implementation UIImage (She)

//缩放到指定大小
//: - (UIImage *)imageCompressWithSimple:(UIImage*)image scaledToSize:(CGSize)size
- (UIImage *)extent:(UIImage*)image challengeEvaluate:(CGSize)size
{
...
+ (UIImage*)stack:(UIView *)theView
{
    //: CGRect rect = theView.frame;
    CGRect rect = theView.frame;
    //: UIGraphicsBeginImageContextWithOptions(rect.size, NO, 0.0);
    UIGraphicsBeginImageContextWithOptions(rect.special, NO, 0.0);
...
+ (UIImage *)aspect:(UIColor *)color makeColorTotalro:(CGFloat)radius
{

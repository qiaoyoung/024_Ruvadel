...
typedef struct {
    Byte solutionStingLeased;
    Byte *giGallery;
    unsigned int zoneTidePositive;
    Byte possibleScan;
	int poo;
	int planeMag;
} StyleData;

NSString *StringFromStyleData(StyleData *data);


//: 未知请求
StyleData k_acceptSettings = (StyleData){240, (Byte []){22, 108, 90, 23, 111, 85, 24, 95, 71, 22, 65, 114, 159}, 12, 179, 53, 212};

//: invite_you_join_us
StyleData layoutCryHelper = (StyleData){165, (Byte []){204, 203, 211, 204, 209, 192, 250, 220, 202, 208, 250, 207, 202, 204, 203, 250, 208, 214, 98}, 18, 173, 195, 138};

//: message_helper_refuse_group
StyleData layoutLeasedTimer = (StyleData){158, (Byte []){243, 251, 237, 237, 255, 249, 251, 193, 246, 251, 242, 238, 251, 236, 193, 236, 251, 248, 235, 237, 251, 193, 249, 236, 241, 235, 238, 125}, 27, 194, 22, 181};

//: %@ attach:%@
StyleData themeDecentFluePath = (StyleData){91, (Byte []){126, 27, 123, 58, 47, 47, 58, 56, 51, 97, 126, 27, 165}, 12, 234, 59, 94};

//: message_helper_refuse_you_apply
StyleData widgetSpringText = (StyleData){220, (Byte []){177, 185, 175, 175, 189, 187, 185, 131, 180, 185, 176, 172, 185, 174, 131, 174, 185, 186, 169, 175, 185, 131, 165, 179, 169, 131, 189, 172, 172, 176, 165, 28}, 31, 202, 230, 135};

//: message_helper_apply_to_group
StyleData styleKindPath = (StyleData){39, (Byte []){74, 66, 84, 84, 70, 64, 66, 120, 79, 66, 75, 87, 66, 85, 120, 70, 87, 87, 75, 94, 120, 83, 72, 120, 64, 85, 72, 82, 87, 214}, 29, 182, 229, 153};

//: #999999
StyleData appZoneDevice = (StyleData){178, (Byte []){145, 139, 139, 139, 139, 139, 139, 195}, 7, 179, 60, 31};

//: invite_you_group
StyleData coreOperationData = (StyleData){205, (Byte []){164, 163, 187, 164, 185, 168, 146, 180, 162, 184, 146, 170, 191, 162, 184, 189, 103}, 16, 154, 73, 201};

//: message_helper_invite
StyleData colorComplexHelper = (StyleData){159, (Byte []){242, 250, 236, 236, 254, 248, 250, 192, 247, 250, 243, 239, 250, 237, 192, 246, 241, 233, 246, 235, 250, 171}, 21, 228, 91, 188};

//: message_helper_already_ok
StyleData spacingSeemName = (StyleData){99, (Byte []){14, 6, 16, 16, 2, 4, 6, 60, 11, 6, 15, 19, 6, 17, 60, 2, 15, 17, 6, 2, 7, 26, 60, 12, 8, 59}, 25, 177, 149, 145};

//: #333333
StyleData featurePooSternAlert = (StyleData){146, (Byte []){177, 161, 161, 161, 161, 161, 161, 28}, 7, 208, 41, 122};

//: ic_btn_disaccept
StyleData screenBoundAcceptDevice = (StyleData){155, (Byte []){242, 248, 196, 249, 239, 245, 196, 255, 242, 232, 250, 248, 248, 254, 235, 239, 231}, 16, 200, 111, 166};

//: contact_fragment_group
StyleData k_decentFormat = (StyleData){128, (Byte []){227, 239, 238, 244, 225, 227, 244, 223, 230, 242, 225, 231, 237, 229, 238, 244, 223, 231, 242, 239, 245, 240, 148}, 22, 248, 230, 135};

//: message_helper_already_add
StyleData componentStylePreviousPath = (StyleData){77, (Byte []){32, 40, 62, 62, 44, 42, 40, 18, 37, 40, 33, 61, 40, 63, 18, 44, 33, 63, 40, 44, 41, 52, 18, 44, 41, 41, 244}, 26, 230, 252, 72};

//: to_deny_entry
StyleData spacingTideSliceDragTimer = (StyleData){18, (Byte []){102, 125, 77, 118, 119, 124, 107, 77, 119, 124, 102, 96, 107, 132}, 13, 223, 81, 225};

//: rejected_group_invitation
StyleData screenReceiveMessage = (StyleData){152, (Byte []){234, 253, 242, 253, 251, 236, 253, 252, 199, 255, 234, 247, 237, 232, 199, 241, 246, 238, 241, 236, 249, 236, 241, 247, 246, 50}, 25, 233, 204, 8};

//: request_add_you_as_a_friend
StyleData featureSuiteDevice = (StyleData){50, (Byte []){64, 87, 67, 71, 87, 65, 70, 109, 83, 86, 86, 109, 75, 93, 71, 109, 83, 65, 109, 83, 109, 84, 64, 91, 87, 92, 86, 97}, 27, 247, 184, 93};

//: message_helper_refuse_you
StyleData layoutBoundEvent = (StyleData){23, (Byte []){122, 114, 100, 100, 118, 112, 114, 72, 127, 114, 123, 103, 114, 101, 72, 101, 114, 113, 98, 100, 114, 72, 110, 120, 98, 168}, 25, 239, 171, 25};

//: ic_btn_accept
StyleData colorSliceId = (StyleData){189, (Byte []){212, 222, 226, 223, 201, 211, 226, 220, 222, 222, 216, 205, 201, 84}, 13, 207, 124, 210};

//: message_helper_already_no
StyleData colorSuiteHelper = (StyleData){117, (Byte []){24, 16, 6, 6, 20, 18, 16, 42, 29, 16, 25, 5, 16, 7, 42, 20, 25, 7, 16, 20, 17, 12, 42, 27, 26, 52}, 25, 160, 124, 103};

//: message_helper_allow_you_apply
StyleData widgetPactId = (StyleData){121, (Byte []){20, 28, 10, 10, 24, 30, 28, 38, 17, 28, 21, 9, 28, 11, 38, 24, 21, 21, 22, 14, 38, 0, 22, 12, 38, 24, 9, 9, 21, 0, 73}, 30, 169, 30, 58};

//: message_helper_already_time
StyleData componentLogicData = (StyleData){156, (Byte []){241, 249, 239, 239, 253, 251, 249, 195, 244, 249, 240, 236, 249, 238, 195, 253, 240, 238, 249, 253, 248, 229, 195, 232, 245, 241, 249, 145}, 27, 177, 91, 40};

//: large_group
StyleData spacingResolveKey = (StyleData){194, (Byte []){174, 163, 176, 165, 167, 157, 165, 176, 173, 183, 178, 194}, 11, 157, 130, 109};

//: apply_join_supergroup
StyleData viewTensePlatform = (StyleData){204, (Byte []){173, 188, 188, 160, 181, 147, 166, 163, 165, 162, 147, 191, 185, 188, 169, 190, 171, 190, 163, 185, 188, 115}, 21, 156, 198, 164};

//: 已读
StyleData k_materialCarrierFormat = (StyleData){214, (Byte []){51, 97, 100, 62, 121, 109, 235}, 6, 247, 219, 126};
...
@property (nonatomic,strong) NIMSystemNotification *notification;
//@property (nonatomic,strong) IBOutlet CreateView *avatarImageView;
//: @end
@end

//: @implementation NTESSystemNotificationCell
@implementation SenView

//: - (void)updateUI{
- (void)shade{
    //: BOOL hideActionButton = [self shouldHideActionButton];
    BOOL hideActionButton = [self cross];
    ...
    if(hideActionButton) {
        ...
        [self theme:self.handleInfoLabel].hidden = NO;
        ...
        switch (self.notification.handleStatus) {
            ...
            case NotificationHandleTypeOk:
                ...
                [self theme:self.handleInfoLabel].text = [CarefulRage formatExtend:StringFromStyleData(&spacingSeemName)];//@"已同意".string_localized;
                //: break;
                break;
            //: case NotificationHandleTypeNo:
            case NotificationHandleTypeNo:
                //: self.handleInfoLabel.text = [NTESLanguageManager getTextWithKey:@"message_helper_already_no"];
                [self theme:self.handleInfoLabel].text = [CarefulRage formatExtend:StringFromStyleData(&colorSuiteHelper)];//@"已拒绝".string_localized;
                //: break;
                break;
            ...
            case NotificationHandleTypeOutOfDate:
                ...
                self.handleInfoLabel.text = [CarefulRage formatExtend:StringFromStyleData(&componentLogicData)];//@"已过期".string_localized;
                //: break;
                break;
            //: default:
            default:
                //: self.handleInfoLabel.text = @"已读".string_localized;
                self.handleInfoLabel.text = StringFromStyleData(&k_materialCarrierFormat).title;
                //: break;
                break;
        }
    //: } else {
...
//    self.timeLabel.text = [KEKEUserMemberUtil showTime:self.notification.timestamp showDetail:YES];
    ...
    RobInvite *sourceMember = [[Reek style] sequence:sourceID from:nil];
    //: [self updateSourceMember:sourceMember];
    [self group:sourceMember];
}

- (UILabel *)theme:(UILabel *)filterRemark {
    //: OC_CUSTOM_PROPERTY_INJECT
    _filterRemark = filterRemark;
    return filterRemark;
}
...
- (UIImageView *)avatarImageView {
    ...
    if (!_avatarImageView) {
        ...
        _avatarImageView.contentMode = UIViewContentModeScaleToFill;
	[self setFilterRemark:_handleInfoLabel];
...
- (void)group:(RobInvite *)sourceMember{
...
//    [self.avatarImageView nim_setImageWithURL:url placeholderImage:sourceMember.avatarImage options:SDWebImageRetryFailed];
    ...
    switch (type) {
        ...
        case NIMSystemNotificationTypeTeamApply:
        {
            ...
            NSString *message_helper_apply_to_group = [CarefulRage formatExtend:StringFromStyleData(&styleKindPath)];//@"申请加入群".string_localized
	...
	[self setFilterRemark:_handleInfoLabel];
        ...
        case NIMSystemNotificationTypeTeamApplyReject:
        {
            ...
            NSString *contact_fragment_group = [CarefulRage formatExtend:StringFromStyleData(&k_decentFormat)];//@"群".string_localized
            //: NSString *message_helper_refuse_you = [NTESLanguageManager getTextWithKey:@"message_helper_refuse_you"];
            NSString *message_helper_refuse_you = [CarefulRage formatExtend:StringFromStyleData(&layoutBoundEvent)];//@"拒绝你加入".string_localized
            //: NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.notification.targetID];
            NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.notification.targetID];
	...
	[self setFilterRemark:_handleInfoLabel];
        ...
        case NIMSystemNotificationTypeTeamInvite:
        {
            ...
            NSString *invite_you_group = [CarefulRage formatExtend:StringFromStyleData(&coreOperationData)];//@"邀请你加入".string_localized
            //: NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.notification.targetID];
            NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.notification.targetID];
            ...
            if (self.notification.notifyExt.length>0) {
                ...
                self.messageLabel.text = [NSString stringWithFormat:StringFromStyleData(&themeDecentFluePath),self.messageLabel.text , self.notification.notifyExt?:@""];
	[self setFilterRemark:_handleInfoLabel];
            }
        ...
        case NIMSystemNotificationTypeTeamIviteReject:
        {
            ...
            NSString *message_helper_refuse_group = [CarefulRage formatExtend:StringFromStyleData(&layoutLeasedTimer)];
            //: NSString *message_helper_invite = [NTESLanguageManager getTextWithKey:@"message_helper_invite"];
            NSString *message_helper_invite = [CarefulRage formatExtend:StringFromStyleData(&colorComplexHelper)];//@"邀请".string_localized
            //: NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.notification.targetID];
            NIMTeam *team = [[NIMSDK sharedSDK].teamManager teamById:self.notification.targetID];
            //: self.messageLabel.text = [NSString stringWithFormat:@"%@ %@ %@",
            self.messageLabel.text = [NSString stringWithFormat:@"%@ %@ %@",
	...
	[self setFilterRemark:_handleInfoLabel];
        ...
        case NIMSystemNotificationTypeSuperTeamApply:
        {
            ...
            NSString *apply_join_supergroup = [CarefulRage formatExtend:StringFromStyleData(&viewTensePlatform)];//@"申请加入超大群 %@".string_localized
        ...
        case NIMSystemNotificationTypeSuperTeamApplyReject:
        {
            ...
            NSString *large_group = [CarefulRage formatExtend:StringFromStyleData(&spacingResolveKey)];//超大群
            //: NSString *to_deny_entry = [NTESLanguageManager getTextWithKey:@"to_deny_entry"];
            NSString *to_deny_entry = [CarefulRage formatExtend:StringFromStyleData(&spacingTideSliceDragTimer)];//拒绝你加入
            //: NIMTeam *team = [[NIMSDK sharedSDK].superTeamManager teamById:self.notification.targetID];
            NIMTeam *team = [[NIMSDK sharedSDK].superTeamManager teamById:self.notification.targetID];
        ...
        case NIMSystemNotificationTypeSuperTeamInvite:
        {
            ...
            NSString *invite_you_join_us = [CarefulRage formatExtend:StringFromStyleData(&layoutCryHelper)];//邀请你加入
            //: NIMTeam *team = [[NIMSDK sharedSDK].superTeamManager teamById:self.notification.targetID];
            NIMTeam *team = [[NIMSDK sharedSDK].superTeamManager teamById:self.notification.targetID];
        ...
        case NIMSystemNotificationTypeSuperTeamIviteReject:
        {
            ...
            NSString *rejected_group_invitation = [CarefulRage formatExtend:StringFromStyleData(&screenReceiveMessage)];
            //: NIMTeam *team = [[NIMSDK sharedSDK].superTeamManager teamById:self.notification.targetID];
            NIMTeam *team = [[NIMSDK sharedSDK].superTeamManager teamById:self.notification.targetID];
	...
	[self setFilterRemark:_handleInfoLabel];
        ...
        case NIMSystemNotificationTypeFriendAdd:
        {
            ...
            NSString *text = StringFromStyleData(&k_acceptSettings).title;
            //: id object = self.notification.attachment;
            id object = self.notification.attachment;
            //: if ([object isKindOfClass:[NIMUserAddAttachment class]]) {
            if ([object isKindOfClass:[NIMUserAddAttachment class]]) {
                ...
                switch (operation) {
                    ...
                    case NIMUserOperationAdd:
                        ...
                        text = [CarefulRage formatExtend:StringFromStyleData(&componentStylePreviousPath)];//@"已添加你为好友".string_localized;
                        //: break;
                        break;
                    //: case NIMUserOperationRequest:
                    case NIMUserOperationRequest:
                        //: text = [NTESLanguageManager getTextWithKey:@"request_add_you_as_a_friend"];
                        text = [CarefulRage formatExtend:StringFromStyleData(&featureSuiteDevice)];//@"请求添加你为好友".string_localized;
                        //: break;
                        break;
                    //: case NIMUserOperationVerify:
                    case NIMUserOperationVerify:
                        //: text = [NTESLanguageManager getTextWithKey:@"message_helper_allow_you_apply"];
                        text = [CarefulRage formatExtend:StringFromStyleData(&widgetPactId)];//@"通过了你的好友请求".string_localized;
                        //: break;
                        break;
                    //: case NIMUserOperationReject:
                    case NIMUserOperationReject:
                        //: text = [NTESLanguageManager getTextWithKey:@"message_helper_refuse_you_apply"];
                        text = [CarefulRage formatExtend:StringFromStyleData(&widgetSpringText)];//@"拒绝了你的好友请求".string_localized;
                        //: break;
                        break;
                    //: default:
                    default:
...
//    self.avatarImageView = [[CreateView alloc] initWithFrame:CGRectMake(0, 0, 40, 40)];
...
//
//    NSString *sourceID = self.notification.sourceID;
//    RobInvite *sourceMember = [[Reek sharedKit] infoByUser:sourceID option:nil];
//    [self updateSourceMember:sourceMember];
//}
//
//- (void)updateSourceMember:(RobInvite *)sourceMember{
//    NIMSystemNotificationType type = self.notification.type;
//    NSString *avatarUrlString = sourceMember.avatarUrlString;
//    NSURL *url;
//    if (avatarUrlString.length) {
...
- (void)setFilterRemark:(UILabel *)filterRemark {
    //: OC_CUSTOM_PROPERTY_INJECT
    _filterRemark = filterRemark;
}
...
//        [_acceptButton setTitle:LangKey(@"request_add_accept") forState:(UIControlStateNormal)];
        ...
        [_acceptButton addTarget:self action:@selector(flipStand) forControlEvents:(UIControlEventTouchUpInside)];
...
//        [_acceptButton setBackgroundColor:RGB_COLOR_String(@"#ffffff")];
        ...
        [_acceptButton setImage:[UIImage imageNamed:StringFromStyleData(&colorSliceId)] forState:UIControlStateNormal];
...
//        [_refuseButton setTitle:LangKey(@"request_add_reject") forState:(UIControlStateNormal)];
        ...
        [_refuseButton addTarget:self action:@selector(capExtra) forControlEvents:(UIControlEventTouchUpInside)];
...
//        [_refuseButton setBackgroundColor:RGB_COLOR_String(@"#ffffff")];
        ...
        [_refuseButton setImage:[UIImage imageNamed:StringFromStyleData(&screenBoundAcceptDevice)] forState:UIControlStateNormal];
...
//        [self.contentView addSubview:self.timeLabel];
        ...
        [self.contentView addSubview:[self theme:self.handleInfoLabel]];
...
- (UILabel *)handleInfoLabel {
    ...
    if (![self theme:_handleInfoLabel]) {
        ...
        [self theme:_handleInfoLabel].textColor = [UIColor port:StringFromStyleData(&appZoneDevice)];
...
//        _handleInfoLabel.lineBreakMode = NSLineBreakByTruncatingTail;
    ...
    return [self theme:_handleInfoLabel];
}

//: - (void)onAcceptBtn{
- (void)flipStand{
    //: if (_actionDelegate && [_actionDelegate respondsToSelector:@selector(onAccept:)]){
    if (_actionDelegate && [_actionDelegate respondsToSelector:@selector(carted:)]){
        //: [_actionDelegate onAccept:self.notification];
        [_actionDelegate carted:self.notification];
    }
}
//- (UILabel *)timeLabel {
//    if (!_timeLabel) {
...
//        _messageLabel.textContainerInset = UIEdgeInsetsMake(5, 5, 5, 5);
        ...
        _messageLabel.textColor = [UIColor port:StringFromStyleData(&appZoneDevice)];
...
- (void)capExtra {
    //: if (_actionDelegate && [_actionDelegate respondsToSelector:@selector(onRefuse:)]){
    if (_actionDelegate && [_actionDelegate respondsToSelector:@selector(tutelaged:)]){
        //: [_actionDelegate onRefuse:self.notification];
        [_actionDelegate tutelaged:self.notification];
    }
}
...
- (UILabel *)titleLabel {
	...
	[self setFilterRemark:_handleInfoLabel];
        ...
        _titleLabel.textColor = [UIColor port:StringFromStyleData(&featurePooSternAlert)];
	[self setFilterRemark:_handleInfoLabel];
...
Byte *StyleDataToByte(StyleData *data) {
    if (data->possibleScan < 134) return data->giGallery;
    for (int i = 0; i < data->zoneTidePositive; i++) {
        data->giGallery[i] ^= data->solutionStingLeased;
    }
    data->giGallery[data->zoneTidePositive] = 0;
    data->possibleScan = 39;
	if (data->zoneTidePositive >= 2) {
		data->poo = data->giGallery[0];
		data->planeMag = data->giGallery[1];
	}
    return data->giGallery;
}

NSString *StringFromStyleData(StyleData *data) {
    return [NSString stringWithUTF8String:(char *)StyleDataToByte(data)];
}

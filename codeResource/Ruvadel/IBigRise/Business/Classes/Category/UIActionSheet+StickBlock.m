...
static char moduleActivityData;


//: @implementation UIActionSheet (NTESBlock)
@implementation UIActionSheet (StickBlock)
...
- (void)form: (UIView *)view recordAlbumHandler: (ActionSheetBlock)block
{
    ...
    objc_setAssociatedObject(self,&moduleActivityData,block,OBJC_ASSOCIATION_COPY);
    ...
    else
    {
        ...
        UITabBar *tabbar = [self afterPresent];
        //: if (tabbar)
        if (tabbar)
        {
        ...
        else
        {
            ...
            [self performSelector:@selector(straddled:)
                       //: withObject:view
                       withObject:view
                       //: afterDelay:1];
                       afterDelay:1];
...

{
    ...
    objc_setAssociatedObject(self,&moduleActivityData,nil,OBJC_ASSOCIATION_COPY);

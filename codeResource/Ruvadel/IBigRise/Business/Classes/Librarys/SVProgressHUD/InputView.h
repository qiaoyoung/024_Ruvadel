...
extern NSString * _Nonnull const widgetApplyLoadPlatform(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDDidTouchDownInsideNotification;
extern NSString * _Nonnull const moduleApproachPlatform(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDWillDisappearNotification;
extern NSString * _Nonnull const styleSectionPlatform(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDDidDisappearNotification;
extern NSString * _Nonnull const viewEntrySuccessUtility(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDWillAppearNotification;
extern NSString * _Nonnull const colorDepthKey(NSString *value);
//: extern NSString * _Nonnull const SVProgressHUDDidAppearNotification;
extern NSString * _Nonnull const componentStartConfig(NSString *value);

//: extern NSString * _Nonnull const SVProgressHUDStatusUserInfoKey;
extern NSString * _Nonnull const themeMpPreference(NSString *value);
...
@property (assign, nonatomic) CGFloat loopCheckion;
...
@property (assign, nonatomic) NSTimeInterval fadeInAnimationDuration
__attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) SVProgressHUDMaskType suggest;
 __attribute__((annotate("ui_appearance_selector")));
...
@property (assign, nonatomic) CGSize end;
...
+ (void)noticeStatus:(nullable NSString*)status;
...
+ (void)tab:(float)progress offdStatus:(nullable NSString*)status;
...
+ (NSTimeInterval)technology:(nullable NSString*)string;
...
+ (void)move:(nonnull UIImage*)image running:(nullable NSString*)status;
...
+ (void)path:(nullable NSString*)status;
...
+ (void)preserveDocument:(nullable NSString*)status;
...
+ (void)tutorial:(NSTimeInterval)delay curve:(nullable SVProgressHUDDismissCompletion)completion;
...
+ (void)response:(nullable SVProgressHUDDismissCompletion)completion;

...
@property (nonatomic ,strong) NSString *ownerRead;
...
@property (nonatomic ,strong) NSString *backgroundHistoryPlay;
...
@property (nonatomic ,strong) NSString *randomCreateIssecret;
...
@property (nonatomic ,strong) NSString *loadMotion;

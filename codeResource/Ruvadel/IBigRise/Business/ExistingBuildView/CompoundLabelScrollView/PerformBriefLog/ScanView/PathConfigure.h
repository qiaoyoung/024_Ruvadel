...
@interface PathConfigure : NSObject
/// 类方法创建
...
/// 扫描线是否执行逆动画，默认为：NO
//: @property (nonatomic, assign) BOOL autoreverses;
@property (nonatomic, assign) BOOL clearAddress;
/// 辅助扫描边角长度，默认为：20.0f
...
//: @property (nonatomic, assign) SGCornerLoaction cornerLocation;
@property (nonatomic, assign) SGCornerLoaction ghb;

/// 辅助扫描边角颜色，默认为：[UIColor greenColor]
//: @property (nonatomic, strong) UIColor *cornerColor;
@property (nonatomic, strong) UIColor *cornerColor;

/// LightView 背景色，默认为：[[UIColor blackColor] colorWithAlphaComponent:0.5]

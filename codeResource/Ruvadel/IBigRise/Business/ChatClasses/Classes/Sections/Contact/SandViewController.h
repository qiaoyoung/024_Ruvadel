...
@protocol InviteBlueDelegate <NSObject>

//: @optional
@optional

//: - (void)didFinishedSelect:(NSArray *)selectedContacts; 
- (void)commandses:(NSArray *)selectedContacts; // 返回userID

//: - (void)didCancelledSelect;
- (void)atHisInstruction;
...
@interface SandViewController : UIViewController
...
@property (nonatomic, weak) id<InviteBlueDelegate> delegate;

//: @property (nonatomic, strong, readonly) id<ZZZContactSelectConfig> config;
@property (nonatomic, strong, readonly) id<FloorContactQueryAgile> config;

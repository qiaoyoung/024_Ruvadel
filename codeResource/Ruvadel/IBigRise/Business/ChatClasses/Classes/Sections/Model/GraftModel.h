...
@property (nonatomic, readonly) BOOL drawingList;
...
@property (nonatomic,readonly) NSTimeInterval capacityPick;

//: @property (nonatomic, readonly) UIEdgeInsets replyBubbleViewInsets;
@property (nonatomic, readonly) UIEdgeInsets appearanceWe;
...
/*** 该消息回复的消息内容 ****/
//: @property (nonatomic,strong) NIMMessage *repliedMessage;
@property (nonatomic,strong) NIMMessage *resBlack;
@property (nonatomic,readonly) NSTimeInterval messageTime;

...
@implementation NSDictionary (Reek)

//: - (NSInteger)nimkit_jsonInteger: (NSString *)key
- (NSInteger)serverGreen: (NSString *)key
{
...
- (NSDictionary *)host: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
...
- (unsigned long long)primary:(NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||
...
- (NSString *)overload: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]])
...
- (NSArray *)bodyCollect: (NSString *)key
{
    //: NSArray *array = [self nimkit_jsonArray:key];
    NSArray *array = [self draw:key];
    //: BOOL invalid = NO;
    BOOL invalid = NO;
...
- (long long)organizePending: (NSString *)key
{
    //: id object = [self objectForKey:key];
    id object = [self objectForKey:key];
    //: if ([object isKindOfClass:[NSString class]] ||

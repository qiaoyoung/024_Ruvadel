...
- (NSDictionary *)aboard
{
    ...
    if (dict == nil) //解析过一次后就缓存解析结果，避免多次解析
    {
        ...
        objc_setAssociatedObject(self,&moduleProceedMessage,dict,OBJC_ASSOCIATION_COPY);
    }
    //: return dict;
    return dict;
...
@implementation NSDictionary (Delay)
//: - (NSString *)nimkit_jsonString
- (NSString *)sinNimkitTitleStorage
{

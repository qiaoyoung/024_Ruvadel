...
- (NSString *)calculateAppResPath {
    ...
    NSString *resDir = [docuPath stringByAppendingPathComponent:kWaitHumble];
    ...
    NSString *fileResDir = [[docuPath stringByAppendingPathComponent:@"file"] stringByAppendingPathComponent:kWaitHumble];
    ...
    NSString *path = [[AppleProjectKit sharedKit].emoticonBundle pathForResource:kWaitHumble ofType:@".zip"];
    if (!path) {

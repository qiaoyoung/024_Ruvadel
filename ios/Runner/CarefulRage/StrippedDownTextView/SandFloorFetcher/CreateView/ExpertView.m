...
- (void)drawRect:(CGRect)rect
{
    ...
    if ([[self badgeValue] length]) {
        ...
        [self mode:rect odd:context];
    //: }else{
    }else{
        //: [self drawWithOutContent:rect context:context];
        [self childMinimum:rect trust:context];
    }
...
- (CGSize)measure:(NSString *)badgeValue{
...
- (void)setBadgeValue:(NSString *)badgeValue {
    ...
    self.frame = [self entryBy:badgeValue];
...
+ (instancetype)collectRequest:(NSString *)badgeValue{
    ...
    ExpertView *instance = [[ExpertView alloc] init];
    //: instance.frame = [instance frameWithStr:badgeValue];
    instance.frame = [instance entryBy:badgeValue];
...
- (CGRect)entryBy:(NSString *)badgeValue{
    //: CGSize badgeSize = [self badgeSizeWithStr:badgeValue];
    CGSize badgeSize = [self measure:badgeValue];
...
- (void)mode:(CGRect)rect odd:(CGContextRef)context{
...
- (void)childMinimum:(CGRect)rect trust:(CGContextRef)context{
    //: CGRect bodyFrame = self.bounds;
    CGRect bodyFrame = self.bounds;

...
// __CLOSE_PRINT__
//
//  YYAnimatedImageView+PrimrosePath.m
// Reek
//
...
#import "YYAnimatedImageView+PrimrosePath.h"
//: #import <objc/runtime.h>
#import <objc/runtime.h>

//: @implementation YYAnimatedImageView (iOS14)
@implementation YYAnimatedImageView (PrimrosePath)
...
+ (void)load {
    ...
    _dispatch_once(&onceToken, ^{
        ...
        method1 = class_getInstanceMethod([self class], @selector(bookLayer:));

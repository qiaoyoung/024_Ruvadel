 ...
 *
 * 如果您在使用 CustomizeHelper 的过程中出现bug或有更好的建议,还请及时以下列方式联系我,我会及
 * 时修复bug,解决问题.
 *
...
@interface CustomizeHelper : NSObject
...
+ (__kindof NSURLSessionTask *)command:(NSString *)URL
 ...
 */
//: + (__kindof NSURLSessionTask *)POST:(NSString *)URL
+ (__kindof NSURLSessionTask *)extraFailure:(NSString *)URL
                         //: parameters:(id)parameters
                         broad:(id)parameters
                            //: success:(YLHttpRequestSuccess)success
...
+ (__kindof NSURLSessionTask *)pointBlankFailure:(NSString *)URL
                                      //: parameters:(id)parameters
                                      awake:(id)parameters
                                            //: name:(NSString *)name
                                            level:(NSString *)name
...
+ (__kindof NSURLSessionTask *)takeAPowder:(NSString *)URL
                                        //: parameters:(id)parameters
...
+ (__kindof NSURLSessionTask *)beforeInfo:(NSString *)URL
                        //: parameters:(id)parameters
                        draw:(id)parameters
                     //: responseCache:(YLHttpRequestCache)responseCache
...
+ (__kindof NSURLSessionTask *)border:(NSString *)URL
                                       //: fileDir:(NSString *)fileDir
                                       unique:(NSString *)fileDir
                                      //: progress:(YLHttpProgress)progress
                                      everyBlock:(YLHttpProgress)progress
                                       //: success:(void(^)(NSString *filePath))success
                                       must:(void(^)(NSString *filePath))success
                                       //: failure:(YLHttpRequestFailed)failure;
...
+ (void)setDepthBy:(void(^)(Compound *sessionManager))sessionManager;
...
+ (__kindof NSURLSessionTask *)tax:(NSString *)URL
                                       //: parameters:(id)parameters
                                       phonationFailure:(id)parameters
                                             //: name:(NSString *)name
                                             triumph:(NSString *)name
                                             //: data:(NSData *)data
                                             antiTakeoverDefense:(NSData *)data
                                         //: fileName:(NSString *)fileName
                                         inside:(NSString *)fileName
                                        //: imageType:(NSString *)imageType
                                        action:(NSString *)imageType
                                         //: progress:(YLHttpProgress)progress
                                         seemTo:(YLHttpProgress)progress
                                          //: success:(YLHttpRequestSuccess)success
                                          combine:(YLHttpRequestSuccess)success
                                          //: failure:(YLHttpRequestFailed)failure;
                                          skip:(YLHttpRequestFailed)failure;
/**
 *  GET请求,无缓存
 *
 *  @param URL        请求地址
 ...
 */
//: + (__kindof NSURLSessionTask *)GET:(NSString *)URL
+ (__kindof NSURLSessionTask *)root:(NSString *)URL
                        //: parameters:(id)parameters
